...
handle_brightness() {
    /opt/janus/bin/janus-pp-rec /home/recordings/$1 /home/recordings/recording.mp4
    ...
    curl -X POST -H "Content-Type: application/json" -d "{\"brightness\": $brightness}" http://192.168.178.80:3333/api/brightness
}
...
handle_motion() {
    ...
    curl -X POST -F file=@/home/recordings/motion.jpg -F date=$(date -Is) http://192.168.178.80:3333/api/snapshot
}
    ...
    then
        case $EVENT in
            ...
            MODIFY)
                ...
                then
                    handle_brightness "recording-video-0.mjr.tmp"
                fi
            ...
            CLOSE)
                ...
                then
                    handle_brightness "recording-video-0.mjr"
                fi
            ;;
        esac
    fi
